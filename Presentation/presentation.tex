...
\begin{frame}{Introduction}
  \begin{itemize}
    ...
    \item DUNE’s \textbf{Phlex} stands for \textbf{P}arallel, \textbf{h}ierarchical, and \textbf{l}ayered \textbf{ex}ecution of data-processing algorithms.
...
\begin{frame}{Problem Statement}
  \begin{itemize}
    ...
    \item How does vertical splitting such as one RNTuple for all data products interact with horizontal granularities (event, spill, element)?
...
\begin{frame}{Write Optimization: Multi-Threaded Chunking}
  ...
  \fbox{\parbox{0.95\textwidth}{\scriptsize
    ...
    \hspace*{1.0em} \texttt{        std::launch::async, thinWorkFunc, first, last, seeds[th], th ));}\\
    \texttt{\} }
  }}
  \vspace{0.5em}
...
\centering
\includegraphics[width=0.9\linewidth]{../experiments/aos_write_times.pdf}
\captionof{figure}{\scriptsize AOS (Array of Structures) Write Performance across different data organization strategies.}
\end{frame}

\begin{frame}{SOA: Write Performance}
\centering
\includegraphics[width=0.9\linewidth]{../experiments/soa_write_times.pdf}
\captionof{figure}{\scriptsize SOA (Structure of Arrays) Write Performance across different data organization strategies.}
\end{frame}
...
\begin{frame}{AOS: File Size Analysis}
\centering
\includegraphics[width=0.9\linewidth]{../experiments/aos_file_sizes.pdf}
\captionof{figure}{\scriptsize AOS (Array of Structures) File Size Analysis across different data organization strategies.}
\end{frame}

\begin{frame}{SOA: File Size Analysis}
\centering
\includegraphics[width=0.9\linewidth]{../experiments/soa_file_sizes.pdf}
\captionof{figure}{\scriptsize SOA (Structure of Arrays) File Size Analysis across different data organization strategies.}
\end{frame}
