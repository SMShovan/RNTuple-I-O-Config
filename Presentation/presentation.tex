...
\captionof{figure}{\scriptsize Write Performance Comparison: AOS vs SOA approaches across different data organization strategies. Red bars represent AOS (Array of Structures) performance, while blue bars show SOA (Structure of Arrays) performance.}
\end{frame}
...
\captionof{figure}{\scriptsize File Size Comparison: Storage efficiency of AOS vs SOA approaches.}
\end{frame}
